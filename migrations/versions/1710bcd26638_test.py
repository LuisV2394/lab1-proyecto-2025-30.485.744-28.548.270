...
Revision ID: 1710bcd26638
Revises: 7b073d9b84fd
Create Date: 2026-01-04 11:13:06.797050
...
revision = '1710bcd26638'
down_revision = '7b073d9b84fd'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('updated_at', mysql.DATETIME(), server_default=sa.text('current_timestamp() ON UPDATE current_timestamp()'), nullable=True),
    sa.ForeignKeyConstraint(['episode_id'], ['episodes.id'], name='fk_order_episode', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['professional_id'], ['professionals.id'], name='fk_order_prof', ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id'),
    mysql_collate='utf8mb4_general_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
    ...
    sa.Column('description', mysql.VARCHAR(length=255), nullable=True),
    sa.Column('created_at', mysql.DATETIME(), server_default=sa.text('current_timestamp()'), nullable=True),
    sa.ForeignKeyConstraint(['payer_id'], ['payers.id'], name='fk_plan_payer', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    mysql_collate='utf8mb4_general_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
